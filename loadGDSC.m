...
% Loading and preprocessing GDSC data
    ...
    cfe = readtable('data/PANCAN_simple_MOBEM.rdata.txt', 'Delimiter', '\t');
    ...
    cfe_cellnameidx = arrayfun(@(x) find(gdsc_cells.CELL_ID==x), cfe_cellids);
...
%     drugIDmap(1060) = 'PD-0325901';
%     drugIDmap(11) = 'Paclitaxel';
%     drugIDmap(1) = 'Erlotinib';
%     drugIDmap(119) = 'Lapatinib';
%     drugIDmap(1013) = 'Nilotinib';
%     drugIDmap(30) = 'Sorafenib';
%     drugIDmap(6) = 'PHA-665752';
%     drugIDmap(1026) = '17-AAG';
%     drugIDmap(1054) = 'PD-0332991';
%     drugIDmap(1047) = 'Nutlin-3';
%     drugIDmap(35) = 'TAE684';
